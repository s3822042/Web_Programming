...
<body>
    <form method="post" class="form-container">
        ...
        <div class="form-control">
            ...
            <input id="password_retype" type="password" name="password_retype" onChange="onChange()" />
        </div>
        <div class="form-control">
...
<script>
    function onChange() {
        ...
        var pwd_retype = document.querySelector('input[name=password_retype]')
        if (pwd.value === pwd_retype.value) {
            pwd_retype.setCustomValidity('');
        } else {
            pwd_retype.setCustomValidity('Passwords do not match');
        }
    }
</script>
