<?php
  ...
  if (isset($_COOKIE['visited']) && $_COOKIE['visited'] == 'yes') {
    $_SESSION['last-visited-product'] = "submariner-black-dial.php";
  } 
...
<html lang="en">
  <head>
    ...
    <title>Submariner black dial</title>
  ...
  <body onmouseover="cartNumbers()">
    ...
    <div class="product_description">
      <div class="product_content">
        <!--product content-->
        <h1 id="product-name">Submariner black dial</h1>
        ...
        <div class="product_detail">
          ...
          <div class="product_general_description">
            ...
            <p id="price">Price: $<span>17495</span></p>
            <!--size selection-->
            <p>Diameter: 41mm</p>
            <p>Color available: Black / Gold / Yellow</p>
            <div>
              <span>
                <img
                  src="https://i.imgur.com/fN53ZCR.jpg"
              ...
              <span>
                <img
                  src="https://i.imgur.com/H48JEau.jpg"
                  class="same_product_another_design"
                  alt="product with another design"
                />
              </span>
            ...
            <br />
            <div class="buying">
              <form method="post" name="product-added-button-form" action="submariner-black-dial.php">
                <input
                  type="number"
                  id="quantity"
                  name="quantity"
        ...
        <div class="detail_description">
          ...
          <p>
            ...
            Uni-directional rotating stainless steel bezel with a black
            cerachrom ring. Black dial with luminous silver-tone Mercedes-logo,
            sword, and Breguet-style shape hands and dot hour markers. Minute
            markers around the outer rim. Dial Type: Analog. Luminescent hands
            and hour markers. Date display at the 3 o'clock position. Rolex
            calibre 3135 automatic movement, containing 31 Jewels, bitting at
            28800 vph, and has a power reserve of approximately 48 hours.
            Scratch resistant sapphire crystal. Screw down crown. Solid case
            back. Round case shape. Case size: 40 mm. Case thickness: 13 mm.
            Band width: 20 mm. Deployment clasp. Water resistant at 300 meters /
            1000 feet. Functions: date, hour, minute, second, chronometer.
            Submariner Series. Dive watch style. Watch label: Swiss Made. Rolex
            Oyster Perpetual Submariner Black Dial Black Cerachrom Bezel Steel
            Men's Watch 116610LN.
          </p>
          <div class="separator"></div>
          <h3>Dial</h3>
          <ul>
            ...
            <li>
              <b>Hands</b> :Luminous Silver-tone Mercedes-logo, sword, and
              Breguet-style shape
            </li>
            <li><b>Dial Markers</b> :Dot</li>
            <li><b>Second Marker</b> :Minute Markers around the outer rim</li>
            <li><b>Luminiscene</b> :Hands and Hour Markers</li>
            <li><b>Bezel</b> :Uni-directional Rotating</li>
            <li><b>Bezel color</b> :Black Top Ring</li>
            <li>
              <b>Bezel material</b> :Stainless Steel and Black Cerachrom Ring
            </li>
          ...
          <ul>
            ...
            <li><b>Case thickness</b> :13 mm</li>
          ...
          <ul>
            ...
            <li>
              <b>Watch features</b> :Analog, Chronometer, Perpetual, Stainless
              Steel
            </li>
          </ul>
          <div class="separator"></div>
          <h3>Band</h3>
          <ul>
            <li><b>Band material</b> :Stainless Steel Oyster</li>
            <li><b>Band type</b> :Bracelet</li>
            <li><b>Band width</b> :20 mm</li>
            <li><b>Band color</b> :Silver-tone</li>
            <li><b>Clasp</b> :Deployment</li>
          </ul>
          <div class="separator"></div>
          <h3>Additional information</h3>
          <ul>
            <li><b>Watch style</b> :Dive</li>
            <li><b>Warranty</b> :2 Year Jomashop Warranty</li>
            <li><b>Internal ID</b> :RLX116610LN</li>
            <li><b>UPC code</b> :4562238260176</li>
